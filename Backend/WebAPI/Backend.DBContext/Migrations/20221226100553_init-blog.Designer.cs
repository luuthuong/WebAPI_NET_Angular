...
namespace Backend.DBContext.Migrations
{
    ...
    [Migration("20221226100553_init-blog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Entities.Entities.Blog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Backend.Entities.Entities.BlogCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Backend.Entities.Entities.BlogComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Backend.Entities.Entities.Blog", b =>
                {
                    b.HasOne("Backend.Entities.Entities.BlogCategory", "Category")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("Backend.Entities.Entities.BlogCategory", b =>
                {
                    b.HasOne("Backend.Entities.Entities.BlogCategory", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("Backend.Entities.Entities.BlogComment", b =>
                {
                    b.HasOne("Backend.Entities.Entities.Blog", "Blog")
                        .WithMany()
                        .HasForeignKey("BlogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Entities.Entities.BlogComment", "ParentComment")
                        .WithMany()
